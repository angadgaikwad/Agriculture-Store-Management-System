        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <hr color="orange"> 
                      <center>
                        <label><b>Search Product by Month: &nbsp</b></label>       
                                <form method="POST" action="orders.php" >
                                    <input type="image" title="search" src="../assets/img/search.png" alt="Search" />
                                    <input type="text" id="search" name="search" class="search-query" placeholder="Enter month">
                                </form>
                    </center>
                        </div>
...
<?php
                                      ...
                                      $var = ''; 
                                        ...
                                        $var = $_POST['search']; 
                                        $query = "SELECT * FROM orders WHERE date_format(order_date, '%b')='$var' ORDER BY order_date ASC";
                                      ...
                                      //$var = (isset($_POST['search']) ? $_POST['search'] : '');
                                     // $query = "SELECT * FROM orders WHERE date_format(order_date, '%b')='$var' ORDER BY order_date ASC";
                                      //$result = mysqli_query($dbconn,$query);
                                      ?>  
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {  
                                              ...
                                              echo "<tr>";
                                                ...
                                                echo "<td><a href='status.php'. $order_id>Change Status</a></td>";
                                              echo "</tr>"; 
                                            }
                                          }
                                          ?>
