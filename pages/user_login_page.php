...
<body class="login-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="../index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by." data-placement="bottom">
                    Agriculture Store
                </a>
    ...
    <div class="page-header" filter-color="orange">
        <div class="page-header-image" style="background-image:url(../assets/img/agri3.jpg)"></div>
        <div class="container">
        ...
        <footer class="footer">
            <div class="container">
                <div class="copyright">
                    ...
                    </script>,</a> Designed and Coded by.
                </div>
            </div>
        </footer>
    </div>
