...
<?php
    ...
    $query1="SELECT sum(prod_qty) as a FROM  order_details WHERE prod_id='$prod_id' GROUP BY prod_id";
    $result1 = mysqli_query($dbconn,$query1);
    $sold1=mysqli_fetch_assoc($result1 );
    $sum=$sold1['a'];
...
?>   
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" alignment="Center">
                    ...
                    <div class="carousel-inner" role="listbox"  >
                        <div class="carousel-item active">
                            ...
                            <img class="Center"  src="../uploads/<?php echo $res['prod_pic1'];?>" alt="First slide" >
                            <?php else: ?>
                    ...
                    <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
                        <i class="now-ui-icons arrows-1_minimal-left" style="color: black; font-size:xx-large "></i>
                    </a>
                    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
                        <i class="now-ui-icons arrows-1_minimal-right" style="color: black; font-size:xx-large "></i>
                    </a>
                    </div>
                </div>
            </div>
